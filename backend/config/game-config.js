/**
 * Game Configuration
 * Central configuration file for Truth of Abyss
 * 
...
export const COMBAT_CONFIG = {
  ...
  // Turn order
  INITIATIVE_BONUS_PER_DEX: 1
}

// =============================================================================
// D&D 5E SRD API CONFIGURATION
// =============================================================================

export const DND_API_CONFIG = {
...
export const EVENT_CONFIG = {
  ...
  // Starting event ID
  STARTING_EVENT: 'start_awakening'
}
 ...
 * @param {number} attributeValue - The attribute score (e.g., 10, 15, 18)
...
export function calculateXPForLevel(level) {
  const { XP_BASE, XP_MULTIPLIER } = CHARACTER_CONFIG.LEVELS
...
// =============================================================================
// RACES DATA (Fallback for guest mode)
// =============================================================================
...
// =============================================================================
// CLASSES DATA (Fallback for guest mode)
// =============================================================================
...
// =============================================================================
// EVENTS DATA (For guest mode - no database required)
// =============================================================================
